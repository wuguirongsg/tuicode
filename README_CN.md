...
![TuiCode 启动界面](screenshot/tuicode.png)

**工作界面**（多智能体 + Diff 预览 + 文件树）

![TuiCode 工作界面](screenshot/screenShot.png)
...
欢迎 Issue 和 PR。提交前请阅读 [CONTRIBUTING.md](CONTRIBUTING.md)，并确保 `pytest -q` 全部通过。
